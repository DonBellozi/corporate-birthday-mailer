...
def email_html(
    ...
    if wish_text:
        wish_block = (
            f'<tr><td style="padding:0 38px 28px 38px;font-family:Georgia,&quot;Times New Roman&quot;,serif;'
            f'font-size:24px;font-style:italic;font-weight:700;line-height:1.6;'
...
<tr><td style="padding:32px 38px 16px 38px;font-family:Georgia,&quot;Times New Roman&quot;,serif;font-size:24px;font-style:italic;font-weight:700;line-height:1.55;color:{text_color};">Добрый день!</td></tr>
<tr><td style="padding:6px 38px 24px 38px;font-family:Georgia,&quot;Times New Roman&quot;,serif;font-size:27px;font-style:italic;font-weight:700;line-height:1.55;color:{text_color};">{html.escape(intro_text)}</td></tr>
{position_block}
{wish_block}
{card_block}
</table>
